      ...
      <div class="content-wrap">
        ...
        <div class="inner content-flex">
          ...
          <div class="contents p-top">
            ...
            <div class="btn-wrap fadeIn"><a class="btn01" href="item-list.html">全ての商品</a></div>

            <div class="top-ranking">
              <div class="head-ttl fadeIn">
                <h2>ランキング</h2>
              </div>
              <div class="ranking-list flex fadeIn">
            ...
            <div class="top-faq">
              ...
              <div class="flex">
                <a class="btn02 fadeIn" href="faq.html#order"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-order.svg" alt="">ご注文・お支払いについて</a>                
                <a class="btn02 fadeIn" href="faq.html#shipping"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-shipping.svg" alt="">配送・送料について</a>                
                <a class="btn02 fadeIn" href="faq.html#return"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-return.svg" alt="">返品・交換について</a>                
              </div>
            </div><!-- /.top-faq -->
